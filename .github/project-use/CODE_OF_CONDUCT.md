...
- **Harassment** of any kind, including offensive comments, intimidation, or unwelcome attention
...
- Project communication channels (chat, email, forums)
...
**conduct@vault-files.dev** (or create appropriate contact method)
...
3. **Description of the incident**, including specific behavior or statements
4. **When and where** the incident occurred
5. **Whether the incident is ongoing**
6. **Any additional context** or screenshots
7. **Whether you've reported this to anyone else**
...
2. **Review** - Community leaders will review the incident and gather additional information
3. **Decision** - Determine appropriate response based on severity and context
4. **Action** - Implement enforcement decision
5. **Follow-up** - Check in with involved parties as appropriate
...
1. Sending an email to **conduct-appeals@vault-files.dev** within 14 days
2. Including the reason you believe the decision was incorrect
...
For questions about this Code of Conduct, please open a discussion in [GitHub Discussions](https://github.com/PtiCalin/vault-files/discussions).
